// wtf.cpp: определяет точку входа для консольного приложения.
//
...
//Get handle for working in console
HWND GetConsoleHwnd()
{
	HWND hwnd;
	wchar_t Old[200];
...
public:
	...
	bool Initialize(HWND hwnd) {
		...
		result = LoadWaveFile("test.wav", &m_secondaryBuffer1);
		if (!result)
		{
			return false;
		}
