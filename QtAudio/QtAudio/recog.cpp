...
std::string mr::recognize(const std::string path) {
	...
	if (curl)
	{
		...
		curl_easy_setopt(curl, CURLOPT_URL, "asr.yandex.net/asr_xml?key=2afd54fe-46b0-4a8c-bc51-3225594f96a2&uuid=01ae13cb7d496daa1e644628b58fb536&topic=queries&lang=ru-RU");
